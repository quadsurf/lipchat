  ...
  if (status) {
      ...
      if (userType === 'DIST') {
          if (viewersStatus) {
            ...
            return <ChatCardLayout chatId={id} approved={true} uri={uri} chatTitle={chatTitle} chatSubTitle={chatSubTitle} chatType={chat.type} audience={level === 'A' ? 'ANY' : 'APPS'} level={level} message={message} date={date} nav={props.nav} chat={chat}/>
          } else {
            // unapproved DIST viewing an approved DIST
            if (chat.type === 'DMU2ADMIN') {
              return <ChatCardLayout chatId={id} approved={true} uri={uri} chatTitle={chatTitle} chatSubTitle={chatSubTitle} chatType={chat.type} audience="PNDS" level={level} message={message} date={date} nav={props.nav} chat={chat}/>
            } else {
        ...
        return <ChatCardLayout chatId={id} approved={true} uri={uri} chatTitle={chatTitle} chatSubTitle={chatSubTitle} chatType={chat.type} audience="SHPS" level={level} message={message} date={date} nav={props.nav} chat={chat}/>
      }
  } else {
    if (status === false) {
