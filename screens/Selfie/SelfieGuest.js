...
import { convertRGBStringIntoArrayOfNumbers,Modals } from '../../utils/Helpers'
...
class Selfie extends Component {
    ...
    const renderLips = ({
      ...
      return (
        <Svg
          ...
          height={this.props.settings.screenHeight}
        >
          <Svg.Path
              fill={activeColor}
              d={upper}
      ...
      <Camera
        ...
        focusDepth={0}>
            ...
            <View style={{
              ...
              bottom: 66,
              left: 0,
              width:this.props.settings.screenWidth*0.7,
              flexDirection: 'row',
            ...
            <TouchableOpacity
              style={{
              position:'absolute',
              top:(this.props.settings.screenHeight/2)-36,
              width:40,height:40,
  ...
  render() {
    const { screenWidth:width,screenHeight:height } = this.props.settings
